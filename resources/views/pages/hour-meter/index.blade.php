...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('report.hour-meter.create') }}" class="btn btn-primary btn-sm text-white fw-medium">+ Hour Meter</a>
        </div>
    </div>
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-striped">
                ...
                @foreach ($reports as $report)
                    <tr>
                        <td class="fw-semibold">{{ $report->created_at }}</td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form action="{{ route('report.destroy', $report->id) }}" method="post" onsubmit="confirmSubmit(event, this)">
                                        @csrf
                                        @method('DELETE')
